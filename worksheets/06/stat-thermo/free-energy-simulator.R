...
draw_surface <- function(box_size,state_radius,well_depth,beta=7,offset=0.0001) {
    ...
    # Draw mesh surface
    rgl.clear()
    surface3d(x_surface,y_surface,z_surface,front="lines",back="lines",axes_visible=FALSE)
...
run_simulation <- function(box_size=10,state_radius=2,well_depth=-2,beta=7,offset=0.0001,
